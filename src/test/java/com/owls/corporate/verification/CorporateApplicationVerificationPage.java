package com.owls.corporate.verification;
...
public class CorporateApplicationVerificationPage extends AbstractPage{
	
	public CorporateApplicationVerificationPage(RemoteWebDriver driver) {
		super(driver);
	...
	public boolean verifyEmployeeRecord() {
		// TODO Auto-generated method stub
